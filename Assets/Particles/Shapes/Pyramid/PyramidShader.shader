...
Shader "PyramidShader"
{
	...
	SubShader
	{
		...
		float2 voronoihash18_g16( float2 p )
		{
		...
		float voronoi18_g16( float2 v, float time, inout float2 id, inout float2 mr, float smoothness )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
			...
			for ( int j = -1; j <= 1; j++ )
			{
				for ( int i = -1; i <= 1; i++ )
			 	{
			 		float2 g = float2( i, j );
			 		float2 o = voronoihash18_g16( n + g );
		...
		{
			half4 color14_g16 = IsGammaSpace() ? half4(630.4628,766.9961,0,1) : half4(1442949,2220982,0,1);
			half4 temp_output_20_0 = ( (float)_IsCorrect == 1.0 ? _Color0 : color14_g16 );
			o.Albedo = temp_output_20_0.rgb;
			o.Emission = temp_output_20_0.rgb;
			half time18_g16 = ( _Time.y * 3.0 );
			float2 coords18_g16 = i.uv_texcoord * 1.0;
			float2 id18_g16 = 0;
			float2 uv18_g16 = 0;
			float voroi18_g16 = voronoi18_g16( coords18_g16, time18_g16, id18_g16, uv18_g16, 0 );
			float2 uv_Texture = i.uv_texcoord * _Texture_ST.xy + _Texture_ST.zw;
			o.Alpha = ( ( voroi18_g16 * tex2D( _Texture, uv_Texture ).a ) * 10.0 );
		}
...
Node;AmplifyShaderEditor.FunctionNode;20;-432,111.5;Inherit;True;SelectionShader;0;;16;1894054bc5ffc824890fd74252bf6f53;0;2;21;INT;0;False;22;FLOAT;0;False;2;FLOAT;15;COLOR;0
...
WireConnection;20;21;6;0
WireConnection;20;22;5;4
WireConnection;22;0;20;15
WireConnection;22;1;21;0
WireConnection;0;0;20;0
WireConnection;0;2;20;0
WireConnection;0;9;22;0
ASEEND*/
//CHKSM=AB7B484D479EB21448F93CADCEF6CBC749CCE77D