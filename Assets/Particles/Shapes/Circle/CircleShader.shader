...
Shader "CircleShader"
{
	...
	SubShader
	{
		...
		float2 voronoihash18_g12( float2 p )
		{
		...
		float voronoi18_g12( float2 v, float time, inout float2 id, inout float2 mr, float smoothness )
		{
			float2 n = floor( v );
			float2 f = frac( v );
			float F1 = 8.0;
			...
			for ( int j = -1; j <= 1; j++ )
			{
				for ( int i = -1; i <= 1; i++ )
			 	{
			 		float2 g = float2( i, j );
			 		float2 o = voronoihash18_g12( n + g );
		...
		{
			half4 color14_g12 = IsGammaSpace() ? half4(630.4628,766.9961,0,1) : half4(1442949,2220982,0,1);
			o.Emission = ( (float)_IsCorrect == 1.0 ? _Color0 : color14_g12 ).rgb;
			half time18_g12 = ( _Time.y * 3.0 );
			float2 coords18_g12 = i.uv_texcoord * 1.0;
			float2 id18_g12 = 0;
			float2 uv18_g12 = 0;
			float voroi18_g12 = voronoi18_g12( coords18_g12, time18_g12, id18_g12, uv18_g12, 0 );
			float2 uv_Texture = i.uv_texcoord * _Texture_ST.xy + _Texture_ST.zw;
			o.Alpha = ( ( voroi18_g12 * tex2D( _Texture, uv_Texture ).a ) * 10.0 );
		}
...
/*ASEBEGIN
Version=18900
1920;0;1920;1019;1179;198;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;14;-472,129;Inherit;True;SelectionShader;0;;12;1894054bc5ffc824890fd74252bf6f53;0;2;21;INT;0;False;22;FLOAT;0;False;2;FLOAT;15;COLOR;0
...
WireConnection;14;21;6;0
WireConnection;14;22;5;4
WireConnection;16;0;14;15
WireConnection;16;1;15;0
WireConnection;0;2;14;0
WireConnection;0;9;16;0
ASEEND*/
//CHKSM=FB1887CFD27781E80BC2DE947C6A546B53217107